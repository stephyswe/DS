...
<head>
    ...
    <meta name="description" content="A la fin d’un voyage à L.A., quatre potes décident de séparer leurs routes et cherchent à vivre de façon mémorable leur dernière journée dans la cité des Anges.">
    ...
    <meta name="twitter:description" content="A la fin d’un voyage à L.A., quatre potes décident de séparer leurs routes et cherchent à vivre de façon mémorable leur dernière journée dans la cité des Anges." />
    ...
    <div id="views">
        <div class="view view--intro" data-view="intro">
            <div class="intro-wrapper">
                ...
                <p class="view-text" data-text="intro:0">Présentent</p>
                ...
                <div class="view-text intro-loaded" data-text="intro:2">
                    ...
                    Nous vous recommandons de brancher vos écouteurs.
                    Vous pouvez passer d'un personnage à l'autre à tout moment.
                </div>
            </div>
        </div>
                    ...
                    <ul class="list-cast">
                        ...
                        <li class="cast-item">
                            <ul class="cast-cardinal">
                                ...
                                <li class="cardinal-item">Jerôme Charvet</li>
                        ...
                        <li class="list-title" data-text="credits:crew">L'équipe</li>
                        ...
                        <li class="cast-item">
                            <ul class="cast-cardinal">
                                ...
                                <li class="cardinal-item"><span data-text="credits:sound">Chef opérateur son</span> - Nicolas Osorio</li>
                                <li class="cardinal-item"><span data-text="credits:grip">Machiniste</span> - Akihiro Hata</li>
                                <li class="cardinal-item"><span data-text="credits:crew">L'équipe</span> - Ambarish Manepalli</li>
                        ...
                        <li class="cast-item">
                            <ul class="cast-cardinal">
                                <li class="cardinal-item cardinal-title" data-text="credits:est">Est</li>
                                <li class="cardinal-item"><span data-text="credits:by">par</span> Akihiro Hata</li>
                                <li class="cardinal-item"><span data-text="credits:dop">Directeur de la photographie </span> - såndl</li>
                                <li class="cardinal-item"><span data-text="credits:sound">Chef opérateur son</span> - Nicolas Osorio</li>
                                <li class="cardinal-item"><span data-text="credits:grip">Machiniste</span> - Ambarish Manepalli</li>
                                <li class="cardinal-item"><span data-text="credits:crew">L'équipe</span> - Rex New</li>
                                <li class="cardinal-item"><span data-text="credits:mix">Mixage</span> - Croissant.</li>
                            </ul>
                        </li>
                        <li class="cast-item">
                        ...
                        <li class="cast-item">
                            <ul class="cast-cardinal">
                                <li class="cardinal-item cardinal-title" data-text="credits:west">Ouest</li>
                                <li class="cardinal-item" data-text="credits:rights">Musique mise à disposition par Freemusicarchive.org</li>
                        ...
                        <li class="credit-item">
                            ...
                            <span data-text="credits:manager">Chargés de production</span> Thia Schuessler <span data-text="credits:and">et</span> Rex New
                            <span data-text="credits:ad">Premier assistant réalisateur</span> ­ Rex New
                        </li>
                        
                        <li class="credit-item">
                            <span data-text="credits:shot">Filmé à Los Angeles en 2016</span>
                        </li>
                        ...
                        <li class="cast-item">
                            <ul class="cast-cardinal">
                                ...
                                <li class="cardinal-item">Sébastien Brothier</li>
                            </ul>
                        </li>

                        <li class="cast-item">
                            <ul class="cast-cardinal">
                                <li class="cardinal-item cardinal-title" data-text="credits:dirtech">Direction technique et développement web</li>
                                <li class="cardinal-item">Maxime Quintard</li>
                                <li class="cardinal-item">Théo Baes</li>
                            </ul>
                        </li>
                        <li class="cast-item">
                            <ul class="cast-cardinal">
                                ...
                                <li class="cardinal-item">Agnès Tiberghien</li>
                            </ul>
                        </li>

                        <li class="credit-item item--thx">
                            <b data-text="credits:thx">Remerciements</b>
                            Family Manepalli, Ford, In & Out, the Los Angeles Dodgers, Tinder Inc, Olivier Demangel, Noémie Merlant, Morgane Fonvieille, Alice Hammer, Kamel Gemra, Emmanuel Reyé, Julie Mathieu, Vincent Ballesstrino, Sean Hart.
                        </li>
        ...
        <div class="view view--about" data-view="about">
            <div class="about-wrapper">
                <div class="about">
                    <h1 class="view-title" data-text="about:0">« Le web est un outil de cinéma. »</h1>
                    ...
                    <p class="view-text" data-text="about:1">
                        Les Cardinaux est un collectif de quatre potes réalisateurs qui confrontent et font résonner leurs quatre points de vue sur le monde. A travers des courts-métrages de fictions qui s’entrecroisent autour d’une intrigue commune, ils explorent de nouvelles formes de narration sur le web.
                    </p>
                    ...
                    <p class="view-text" data-text="about:3">
                        Après le lancement en 2013 de l’expérience de fiction web L'Apocalypse,<br>Let’s make it count est le deuxième volet de leur collection de courts-métrages.
                    </p>
                    ...
                    <p class="view-text" data-text="about:8">
                        Ne ratez pas les prochains courts-métrages des Cardinaux
                    </p>
    ...
    <menu>
        <ul class="menu-list">
            <li class="menu-item switch">
                <span class="switch-title" data-text="interface:quality">Qualité</span>
            ...
            <li class="menu-item" data-href="credits" data-text="interface:credits">Crédits</li>
